...
count_sum=8				#Cout total
echo -e ">>> Compilation du répertoire `pwd`"
echo -e "$green"
echo -e "[Etape $count_step / $count_sum] >>> Nettoyage du répertoire $output_dir..."
echo -e "$orange"
rm -R $output_dir/*
echo -e "$green"
echo -e "[Etape $count_step / $count_sum] >>> Nettoyage du répertoire $output_dir effectué"
let count_step++
echo -e "[Etape $count_step / $count_sum] >>> Nettoyage du fichier des journaux Latex..."
echo "" > render_report.txt
echo -e "[Etape $count_step / $count_sum] >>> Nettoyage du fichier des journaux Latex effectué"
let count_step++
echo -e "[Etape $count_step / $count_sum] >>> Génération du fichier d'importation (import_content.tex) et importation des bilbiothèques..."
echo -e "$default"
	...
	if [ -f "$item" ];then
		if [ `echo $item | grep Utils/Utils.sty` ];then
			...
			if [ `echo $item | grep .sty` ];then  #package
				...
				echo -e "$green >>> Classe $item disponible"
			fi
		fi
	fi
done
echo -e "$green>>> $sum_lib Bibliothèques importées !"
echo -e "$default"
...
echo -e "$green"
echo -e "[Etape $count_step / $count_sum] >>> Génération du fichier d'importation des parties (Parts) effectuée"
let count_step++
echo -e "[Etape $count_step / $count_sum] >>> Première compilation du fichier $main.tex..."
echo -e "$orange"
pdflatex --output-dir=$output_dir $main.tex >> render_report.txt
echo -e "$green"
echo -e "[Etape $count_step / $count_sum] >>> Première compilation du fichier $main.tex effectuée"
let count_step++
echo -e "[Etape $count_step / $count_sum] >>> Compilation du glossaire..."
echo -e "$orange"
makeglossaries $output_dir/$main >> render_report.txt
echo -e "$green"
echo -e "[Etape $count_step / $count_sum] >>> Compilation du glossaire effectuée"
let count_step++
echo -e "[Etape $count_step / $count_sum] >>> Compilation de la nomenclature...."
echo -e "$orange"
...
echo -e "$green"
echo -e "[Etape $count_step / $count_sum] >>> Compilation de la nomenclature effectuée"
let count_step++
echo -e "[Etape $count_step / $count_sum] >>> Seconde compilation du fichier $main.tex..."
echo -e "$orange"
pdflatex --output-dir=$output_dir $main >> render_report.txt
echo -e "$green"
echo -e "[Etape $count_step / $count_sum] >>> Seconde compilation du fichier $main.tex terminée"
let count_step++
echo -e "[Etape $count_step / $count_sum] >>> Déplacement du fichier $main.pdf..."
echo -e "$orange"
mv $output_dir/$main.pdf $main.pdf >> render_report.txt
echo -e "$green"
echo -e "[Etape $count_step / $count_sum] >>> Déplacement du fichier $main.pdf à la racine du projet terminé..."
echo -e "$orange"
