...
\setHeaderImage{Images_examples/tux.png}{0.8}{Synthèse Latex}{Exemples et références}{Nicolas Le Guerroué}{\today}
...
\img{Images_examples/tux.png}{Légende de l'image}{0.5}
\index{img}
...
\imgf{Images_examples/tux.png}{Tux}{0.6}{0.5}
\index{imgf}
