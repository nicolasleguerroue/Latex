%Fichier Présentation du projet
...
\section{PyModBus}
\subsection{Présentation}
\eMod{PyModBus} est une bibliothèque Python pour communiquer entre des périphériques avec le protocole ModBus analogue à celui de l'API.
...
Ce module utilise la bibliothèque \eMod{PyModBus} en interne.
 Ainsi, toutes les fonctions d'écriture/lecture des données sont protégées des mauvaises manipulations de programmation. \newline
Un tutoriel de prise en main du module \eMod{ENIBSupervision} est disponible en annexe.

\subsection{Installation}

Il est possible d'installer la bibliothèque \eMod{Pymodbus} de deux manières : \newline
