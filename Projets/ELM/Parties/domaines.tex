...
\img{Images/graetz}{Le pont de Graetz}{0.5}

\img{Images/graetz_input}{La tension en sortie du pont}{0.5}
...
\img{Images/out_filtre.png}{Le circuit de filtrage }{0.5}

Observons le résultat.

\img{Images/graetz_out}{La tension aux bornes du condensateur }{0.7}
...
\img{Images/cmos_purpose.png}{Schéma d'exploitation}{0.3}
...
\img{Images/real_input_cmos.png}{Modèle équivalent des entrées CMOS}{0.3}
...
\img{Images/noise.png}{Modèle équivalent du circuit}{0.3}
...
\img{Images/capa_decouplage.png}{Le placement du condensateur de découplage}{0.5}
...
\img{Images/sinus.png}{Le signal à amplifier}{0.6}
...
\img{Images/bridge.png}{Montage pour recentrer la tension}{0.4}
...
\img{Images/bridge_level.png}{Tension positive}{0.5}

Il nous reste à amplifier la tension OUTPUT (ici par 2). Nous obtenons donc une tension sinusoïdale d'amplitude 2V. \n

\img{Images/bridge_output.png}{Schéma avec les deux condensateurs de liaison}{0.7}
...
\img{Images/vs_liaison.png}{La tension de sortie}{0.6}
