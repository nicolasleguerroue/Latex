...
let count_step++
echo -e "[Etape $count_step / $count_sum] >>> Nettoyage des fichiers des journaux Latex..."
...
echo -e "$green"
echo -e "[Step $count_step / $count_sum] >>> Génération du fichier d'importation des parties (Parts) effectuée"
let count_step++
echo -e "[Step $count_step / $count_sum] >>> First compilation of '$main.tex' file..."
echo -e "$orange"
pdflatex --output-dir=$output_dir $main.tex >> render_report_log.txt
echo -e "$green"
echo -e "[Step $count_step / $count_sum] >>> First compilation of '$main.tex' file over !"
let count_step++
echo -e "[Step $count_step / $count_sum] >>> Glossary compilation..."
echo -e "$orange"
makeglossaries $output_dir/$main >> render_report.txt
echo -e "$green"
echo -e "[Step $count_step / $count_sum] >>> Glossary compilation over !"
let count_step++
echo -e "[Step $count_step / $count_sum] >>> Compilation de la nomenclature...."
echo -e "$orange"
...
echo -e "$green"
echo -e "[Step $count_step / $count_sum] >>> Compilation de la nomenclature effectuée"
let count_step++
echo -e "[Step $count_step / $count_sum] >>> Seconde compilation du fichier $main.tex..."
echo -e "$orange"
pdflatex --output-dir=$output_dir $main >> render_report.txt
echo -e "$green"
echo -e "[Step $count_step / $count_sum] >>> Seconde compilation du fichier $main.tex terminée"
let count_step++
echo -e "[Step $count_step / $count_sum] >>> Déplacement du fichier $main.pdf..."
echo -e "$orange"
mv $output_dir/$main.pdf $main.pdf >> render_report.txt
echo -e "$green"
echo -e "[Step $count_step / $count_sum] >>> Déplacement du fichier $main.pdf à la racine du projet terminé..."
echo -e "$orange"
echo -e ">>> Warnings : "
