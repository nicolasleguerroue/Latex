...
\begin{items}{orange}{\Triangle}
    \item \bold{Dans la mesure du possible, évitez d'imprimer ce document si ce n'est pas nécessaire. Il est optimisé pour une visualisation sur un ordinateur et contient beaucoup d'images. La planète vous remercie.}
\end{items}
