...
\img{Images/connexion.png}{Sélection de la liste}{0.9}

Le menu suivant apparaît : \\

\img{Images/zoom_connexion.png}{Éléments de l'objet \bold{Connexion}}{0.6}
...
\img{Images/connexion_begin.png}{Définition de la liste}{0.8}
...
\img{Images/bluetooth_place.png}{Sélection du client Bluetooth}{0.8}

Puis

\img{Images/client.png}{Sélection du bloc des adresses}{0.8}

Au final, on obtient le bloc suivant : 

\img{Images/bloc1.png}{Bloc de configuration de la liste}{0.8}
...
\begin{itemize}
    ...
    On remplace donc le mot « Connexion » par l'adresse MAC\footnote{L'adresse MAC est une adresse physique pour identifier de manière unique un composant.} sélectionnée et on définit la couleur d'arrière-plan en vert, pour obtenir ceci :
     ...
     \img{Images/mac.png}{Rendu de l'état de connexion}{0.5}
...
\img{Images/ifelse.png}{Emplacement des blocs conditionnels}{0.8}

Nous aurons également besoin d'un bloc de comparaison : 

\img{Images/equal.png}{Emplacement des blocs de comparaison}{0.8}


Les blocs de couleurs sont disponibles à l'emplacement suivant : 

\img{Images/colors.png}{Emplacement des blocs de couleurs}{0.8}


Enfin, les chaînes de caractères sont disponibles à l'emplacement suivant : 

\img{Images/string.png}{Emplacement des chaînes de caractères}{0.8}
...
\img{Images/connect.png}{Gestion de la liste après sélection}{0.6}
...
\img{Images/zoom_bouton.png}{Menu du bouton Avancer}{0.6}
...
\img{Images/bouton_avancer.png}{Code du bouton Avancer}{0.6}
...
\img{Images/bouton_gauche.png}{Code du bouton Gauche }{0.6}
